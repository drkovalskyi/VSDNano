...
#pragma link C++ class VsdBase+;

#pragma link C++ class VsdVertex+;
#pragma link C++ class std::vector<VsdVertex>+;

#pragma link C++ class VsdCandidate+;
#pragma link C++ class std::vector<VsdCandidate>+;
